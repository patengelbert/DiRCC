# _hw.tcl file for dircc_nios_processing
package require -exact qsys 14.0

# module properties
set_module_property NAME {dircc_nios_processing_export}
set_module_property DISPLAY_NAME {dircc_nios_processing_export_display}
...
proc compose { } {
    ...
    add_instance cpu altera_nios2_gen2 16.1
    ...
    add_instance fifo_in altera_avalon_fifo 16.1
    set_instance_parameter_value fifo_in {avalonMMAvalonMMDataWidth} {32}
    set_instance_parameter_value fifo_in {avalonMMAvalonSTDataWidth} {32}
    set_instance_parameter_value fifo_in {bitsPerSymbol} {8}
    set_instance_parameter_value fifo_in {channelWidth} {0}
    set_instance_parameter_value fifo_in {errorWidth} {0}
    set_instance_parameter_value fifo_in {fifoDepth} {16}
    set_instance_parameter_value fifo_in {fifoInputInterfaceOptions} {AVALONST_SINK}
    set_instance_parameter_value fifo_in {fifoOutputInterfaceOptions} {AVALONMM_READ}
    set_instance_parameter_value fifo_in {showHiddenFeatures} {0}
    set_instance_parameter_value fifo_in {singleClockMode} {1}
    set_instance_parameter_value fifo_in {singleResetMode} {0}
    set_instance_parameter_value fifo_in {symbolsPerBeat} {4}
    set_instance_parameter_value fifo_in {useBackpressure} {1}
    set_instance_parameter_value fifo_in {useIRQ} {0}
    set_instance_parameter_value fifo_in {usePacket} {1}
    set_instance_parameter_value fifo_in {useReadControl} {0}
    set_instance_parameter_value fifo_in {useRegister} {1}
    set_instance_parameter_value fifo_in {useWriteControl} {1}

    add_instance fifo_out altera_avalon_fifo 16.1
    set_instance_parameter_value fifo_out {avalonMMAvalonMMDataWidth} {32}
    set_instance_parameter_value fifo_out {avalonMMAvalonSTDataWidth} {32}
    set_instance_parameter_value fifo_out {bitsPerSymbol} {8}
    set_instance_parameter_value fifo_out {channelWidth} {0}
    set_instance_parameter_value fifo_out {errorWidth} {0}
    set_instance_parameter_value fifo_out {fifoDepth} {16}
    set_instance_parameter_value fifo_out {fifoInputInterfaceOptions} {AVALONMM_WRITE}
    set_instance_parameter_value fifo_out {fifoOutputInterfaceOptions} {AVALONST_SOURCE}
    set_instance_parameter_value fifo_out {showHiddenFeatures} {0}
    set_instance_parameter_value fifo_out {singleClockMode} {1}
    set_instance_parameter_value fifo_out {singleResetMode} {0}
    set_instance_parameter_value fifo_out {symbolsPerBeat} {4}
    set_instance_parameter_value fifo_out {useBackpressure} {1}
    set_instance_parameter_value fifo_out {useIRQ} {0}
    set_instance_parameter_value fifo_out {usePacket} {1}
    set_instance_parameter_value fifo_out {useReadControl} {0}
    set_instance_parameter_value fifo_out {useRegister} {1}
    set_instance_parameter_value fifo_out {useWriteControl} {1}
    ...
    add_instance mem altera_avalon_onchip_memory2 16.1
    ...
    set_connection_parameter_value cpu.data_master/jtag_uart.avalon_jtag_slave baseAddress {0x00021070}
    ...
    add_connection cpu.data_master fifo_out.in avalon
    set_connection_parameter_value cpu.data_master/fifo_out.in arbitrationPriority {1}
    set_connection_parameter_value cpu.data_master/fifo_out.in baseAddress {0x00021068}
    set_connection_parameter_value cpu.data_master/fifo_out.in defaultConnection {0}

    add_connection cpu.data_master fifo_out.in_csr avalon
    set_connection_parameter_value cpu.data_master/fifo_out.in_csr arbitrationPriority {1}
    set_connection_parameter_value cpu.data_master/fifo_out.in_csr baseAddress {0x00021040}
    set_connection_parameter_value cpu.data_master/fifo_out.in_csr defaultConnection {0}

    add_connection cpu.data_master fifo_in.in_csr avalon
    set_connection_parameter_value cpu.data_master/fifo_in.in_csr arbitrationPriority {1}
    set_connection_parameter_value cpu.data_master/fifo_in.in_csr baseAddress {0x00021020}
    set_connection_parameter_value cpu.data_master/fifo_in.in_csr defaultConnection {0}

    add_connection cpu.data_master fifo_in.out avalon
    set_connection_parameter_value cpu.data_master/fifo_in.out arbitrationPriority {1}
    set_connection_parameter_value cpu.data_master/fifo_in.out baseAddress {0x00021060}
    set_connection_parameter_value cpu.data_master/fifo_in.out defaultConnection {0}

    add_connection cpu.data_master timer.s1 avalon
    set_connection_parameter_value cpu.data_master/timer.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu.data_master/timer.s1 baseAddress {0x00021000}
    set_connection_parameter_value cpu.data_master/timer.s1 defaultConnection {0}
    ...
    add_connection clk.clk fifo_out.clk_in clock

    add_connection clk.clk fifo_in.clk_in clock

    add_connection cpu.irq timer.irq interrupt
    ...
    add_connection clk.clk_reset fifo_out.reset_in reset

    add_connection clk.clk_reset fifo_in.reset_in reset
    ...
    add_interface stream_in avalon_streaming sink
    set_interface_property stream_in EXPORT_OF fifo_in.in
    add_interface stream_out avalon_streaming source
    set_interface_property stream_out EXPORT_OF fifo_out.out
