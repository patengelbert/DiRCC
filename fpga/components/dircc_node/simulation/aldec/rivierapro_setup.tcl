...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_routing_avalon_st_adapter_001_channel_adapter_0.sv"                -work channel_adapter_0                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_routing_avalon_st_adapter_channel_adapter_0.sv"                    -work channel_adapter_0                     
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                     
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_rsp_mux_001.sv"                       -work rsp_mux_001                           
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work rsp_mux_001                           
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work rsp_mux                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                             
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                           
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work cmd_mux_001                           
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work cmd_mux                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_cmd_demux_001.sv"                     -work cmd_demux_001                         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                             
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_router_003.sv"                        -work router_003                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_router_002.sv"                        -work router_002                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_router_001.sv"                        -work router_001                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0_router.sv"                            -work router                                
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu_cpu_debug_slave_sysclk.v"                           -work cpu                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu_cpu_test_bench.v"                                   -work cpu                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu_cpu_debug_slave_wrapper.v"                          -work cpu                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu_cpu_debug_slave_tck.v"                              -work cpu                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu_cpu.v"                                              -work cpu                                   
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_avalon_st_adapter_001_timing_adapter_0.sv"                         -work timing_adapter_0                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_avalon_st_adapter_001_timing_adapter_0_fifo.sv"                    -work timing_adapter_0                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_avalon_st_adapter_timing_adapter_0.sv"                             -work timing_adapter_0                      
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_routing_avalon_st_adapter_001.v"                                   -work avalon_st_adapter_001                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_routing_avalon_st_adapter.v"                                       -work avalon_st_adapter                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_router.sv"                                                              -work router                                
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_routing_output_demux.sv"                                           -work output_demux                          
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_routing_input_mux.sv"                                              -work input_mux                             
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                      -work input_fifo_east                       
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_node_processing_irq_mapper.sv"                                          -work irq_mapper                            
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_mm_interconnect_0.v"                                    -work mm_interconnect_0                     
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_timer.v"                                                -work timer                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_mem.v"                                                  -work mem                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_jtag_uart.v"                                            -work jtag_uart                             
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_fifo_out.v"                                             -work fifo_out                              
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_fifo_in.v"                                              -work fifo_in                               
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing_cpu.v"                                                  -work cpu                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/conduit_avalon_mm_bridge.v"                                                   -work conduit_avalon_mm_bridge_0            
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_avalon_st_adapter_001.v"                                           -work avalon_st_adapter_001                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_avalon_st_adapter.v"                                               -work avalon_st_adapter                     
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_routing.v"                                                         -work routing                               
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_node_processing.v"                                                      -work processing                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/dircc_address_gen.sv"                                                         -work dircc_address                         
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_node.v"                                                                                                                        
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L error_adapter_0 -L channel_adapter_0 -L avalon_st_adapter -L crosser -L rsp_mux_001 -L rsp_mux -L rsp_demux -L cmd_mux_001 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L router_003 -L router_002 -L router_001 -L router -L jtag_uart_avalon_jtag_slave_agent -L cpu_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L cpu_data_master_translator -L cpu -L timing_adapter_0 -L avalon_st_adapter_001 -L output_demux -L input_mux -L input_fifo_east -L rst_controller -L irq_mapper -L mm_interconnect_0 -L timer -L mem -L jtag_uart -L fifo_out -L fifo_in -L conduit_avalon_mm_bridge_0 -L routing -L processing -L dircc_address -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
