...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_routing_avalon_st_adapter_001_channel_adapter_0.sv" -work channel_adapter_0    
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_routing_avalon_st_adapter_channel_adapter_0.sv"     -work channel_adapter_0    
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/dircc_routing_avalon_st_adapter_001.v"                    -work avalon_st_adapter_001
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/dircc_routing_avalon_st_adapter.v"                        -work avalon_st_adapter    
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/interface.sv"                                             -work router               
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/test_read_write.sv"                                       -work router               
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/top.sv"                                                   -work router               
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                  -work input_fifo_0         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/dircc_routing.v"                                                                                
fi
