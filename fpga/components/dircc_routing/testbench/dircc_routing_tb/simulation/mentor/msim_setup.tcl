...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_routing_output_demux.sv"  -L altera_common_sv_packages -work output_demux                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dircc_routing_input_mux.sv"     -L altera_common_sv_packages -work input_mux                         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                     -work input_fifo_east                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_reset_source.sv"  -L altera_common_sv_packages -work dircc_routing_inst_reset_bfm      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_sink_bfm.sv"   -L altera_common_sv_packages -work dircc_routing_inst_output_east_bfm
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_source_bfm.sv" -L altera_common_sv_packages -work dircc_routing_inst_input_east_bfm 
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_clock_source.sv"  -L altera_common_sv_packages -work dircc_routing_inst_clk_bfm        
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_conduit_bfm.sv"          -L altera_common_sv_packages -work dircc_routing_inst_address_bfm    
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/dircc_routing.v"                                             -work dircc_routing_inst                
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dircc_routing_tb.v"                                                                                             
}
