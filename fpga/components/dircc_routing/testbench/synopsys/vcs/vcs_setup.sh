...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_avalon_sc_fifo.v \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_avalon_reset_source.sv \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_avalon_st_source_bfm.sv \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_avalon_clock_source.sv \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/altera_conduit_bfm.sv \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/submodules/dircc_routing.v \
  $QSYS_SIMDIR/dircc_routing_tb/simulation/dircc_routing_tb.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
