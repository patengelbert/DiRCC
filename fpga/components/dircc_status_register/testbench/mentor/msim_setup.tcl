...
# ----------------------------------------
# If dircc_status_register_tb is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dircc_status_register_tb"
}
...
ensure_lib                                              ./libraries/dircc_status_register_inst_status_bfm/
vmap       dircc_status_register_inst_status_bfm        ./libraries/dircc_status_register_inst_status_bfm/ 
ensure_lib                                              ./libraries/dircc_status_register_inst_reset_bfm/ 
vmap       dircc_status_register_inst_reset_bfm         ./libraries/dircc_status_register_inst_reset_bfm/ 
ensure_lib                                              ./libraries/dircc_status_register_inst_clk_bfm/   
vmap       dircc_status_register_inst_clk_bfm           ./libraries/dircc_status_register_inst_clk_bfm/ 
ensure_lib                                              ./libraries/dircc_sv_packages/                   
vmap       dircc_sv_packages                            ./libraries/dircc_sv_packages/    
ensure_lib                                              ./libraries/dircc_status_register_inst/           
vmap       dircc_status_register_inst                   ./libraries/dircc_status_register_inst/           
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_status_register_tb/simulation/submodules/verbosity_pkg.sv"                                            -work altera_common_sv_packages                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_status_register_tb/simulation/submodules/avalon_mm_pkg.sv"                                            -work altera_common_sv_packages                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_status_register_tb/simulation/submodules/avalon_utilities_pkg.sv"                                     -work altera_common_sv_packages                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_status_register_tb/simulation/submodules/altera_avalon_mm_master_bfm.sv" -L altera_common_sv_packages -work dircc_status_register_inst_status_bfm
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dircc_status_register_tb/simulation/submodules/altera_avalon_reset_source.sv"  -L altera_common_sv_packages -work dircc_status_register_inst_reset_bfm 
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L dircc_status_register_inst_status_bfm  -L dircc_status_register_inst_reset_bfm -L dircc_status_register_inst_clk_bfm -L dircc_sv_packages -L dircc_status_register_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L dircc_status_register_inst_status_bfm  -L dircc_status_register_inst_reset_bfm -L dircc_status_register_inst_clk_bfm -L dircc_sv_packages -L dircc_status_register_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
