	dircc_routing u0 (
		...
		.input_poets_data           (<connected-to-input_poets_data>),           //  input_poets.data
		.input_poets_valid          (<connected-to-input_poets_valid>),          //             .valid
		.input_poets_ready          (<connected-to-input_poets_ready>),          //             .ready
		.input_poets_startofpacket  (<connected-to-input_poets_startofpacket>),  //             .startofpacket
		.input_poets_endofpacket    (<connected-to-input_poets_endofpacket>),    //             .endofpacket
		.input_poets_empty          (<connected-to-input_poets_empty>),          //             .empty
		...
		.output_poets_data          (<connected-to-output_poets_data>),          // output_poets.data
		.output_poets_valid         (<connected-to-output_poets_valid>),         //             .valid
		.output_poets_ready         (<connected-to-output_poets_ready>),         //             .ready
		.output_poets_startofpacket (<connected-to-output_poets_startofpacket>), //             .startofpacket
		.output_poets_endofpacket   (<connected-to-output_poets_endofpacket>),   //             .endofpacket
		.output_poets_empty         (<connected-to-output_poets_empty>),         //             .empty
