// dircc_system_node_dual_hps_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module dircc_system_node_dual_hps_mm_interconnect_0 (
		...
		input  wire        node_0_reset_processing_reset_bridge_in_reset_reset,            //            node_0_reset_processing_reset_bridge_in_reset.reset
		...
		output wire [1:0]  node_0_processing_mem_byteenable,                               //                                                         .byteenable
		output wire        node_0_processing_mem_chipselect,                               //                                                         .chipselect
		output wire        node_0_processing_mem_clken,                                    //                                                         .clken
		...
		output wire [1:0]  node_1_processing_mem_byteenable,                               //                                                         .byteenable
		output wire        node_1_processing_mem_chipselect,                               //                                                         .chipselect
		output wire        node_1_processing_mem_clken                                     //                                                         .clken
	);
	...
	wire  [103:0] node_0_processing_mem_agent_rf_source_data;                // node_0_processing_mem_agent:rf_source_data -> node_0_processing_mem_agent_rsp_fifo:in_data
	...
	wire  [103:0] node_0_processing_mem_agent_rsp_fifo_out_data;             // node_0_processing_mem_agent_rsp_fifo:out_data -> node_0_processing_mem_agent:rf_sink_data
	...
	wire  [103:0] node_1_processing_mem_agent_rf_source_data;                // node_1_processing_mem_agent:rf_source_data -> node_1_processing_mem_agent_rsp_fifo:in_data
	...
	wire  [103:0] node_1_processing_mem_agent_rsp_fifo_out_data;             // node_1_processing_mem_agent_rsp_fifo:out_data -> node_1_processing_mem_agent:rf_sink_data
	...
	wire  [102:0] node_0_processing_mem_agent_rp_data;                       // node_0_processing_mem_agent:rp_data -> router_002:sink_data
	...
	wire  [102:0] node_1_processing_mem_agent_rp_data;                       // node_1_processing_mem_agent:rp_data -> router_003:sink_data
	...
	wire  [120:0] router_src_data;                                           // router:src_data -> HPS_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [120:0] hps_h2f_axi_master_wr_limiter_cmd_src_data;                // HPS_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [120:0] rsp_mux_src_data;                                          // rsp_mux:src_data -> HPS_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [120:0] hps_h2f_axi_master_wr_limiter_rsp_src_data;                // HPS_h2f_axi_master_wr_limiter:rsp_src_data -> HPS_h2f_axi_master_agent:write_rp_data
	...
	wire  [120:0] router_001_src_data;                                       // router_001:src_data -> HPS_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [120:0] hps_h2f_axi_master_rd_limiter_cmd_src_data;                // HPS_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [120:0] rsp_mux_001_src_data;                                      // rsp_mux_001:src_data -> HPS_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [120:0] hps_h2f_axi_master_rd_limiter_rsp_src_data;                // HPS_h2f_axi_master_rd_limiter:rsp_src_data -> HPS_h2f_axi_master_agent:read_rp_data
	...
	wire  [102:0] node_0_processing_mem_burst_adapter_source0_data;          // node_0_processing_mem_burst_adapter:source0_data -> node_0_processing_mem_agent:cp_data
	...
	wire    [1:0] node_0_processing_mem_burst_adapter_source0_channel;       // node_0_processing_mem_burst_adapter:source0_channel -> node_0_processing_mem_agent:cp_channel
	...
	wire  [102:0] node_1_processing_mem_burst_adapter_source0_data;          // node_1_processing_mem_burst_adapter:source0_data -> node_1_processing_mem_agent:cp_data
	...
	wire    [1:0] node_1_processing_mem_burst_adapter_source0_channel;       // node_1_processing_mem_burst_adapter:source0_channel -> node_1_processing_mem_agent:cp_channel
	...
	wire  [102:0] router_002_src_data;                                       // router_002:src_data -> node_0_processing_mem_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                      // node_0_processing_mem_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                    // router_002:src_channel -> node_0_processing_mem_rsp_width_adapter:in_channel
	...
	wire  [120:0] node_0_processing_mem_rsp_width_adapter_src_data;          // node_0_processing_mem_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] node_0_processing_mem_rsp_width_adapter_src_channel;       // node_0_processing_mem_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [102:0] router_003_src_data;                                       // router_003:src_data -> node_1_processing_mem_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                      // node_1_processing_mem_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                    // router_003:src_channel -> node_1_processing_mem_rsp_width_adapter:in_channel
	...
	wire  [120:0] node_1_processing_mem_rsp_width_adapter_src_data;          // node_1_processing_mem_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [1:0] node_1_processing_mem_rsp_width_adapter_src_channel;       // node_1_processing_mem_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [120:0] cmd_mux_src_data;                                          // cmd_mux:src_data -> node_0_processing_mem_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                         // node_0_processing_mem_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                       // cmd_mux:src_channel -> node_0_processing_mem_cmd_width_adapter:in_channel
	...
	wire  [102:0] node_0_processing_mem_cmd_width_adapter_src_data;          // node_0_processing_mem_cmd_width_adapter:out_data -> node_0_processing_mem_burst_adapter:sink0_data
	...
	wire    [1:0] node_0_processing_mem_cmd_width_adapter_src_channel;       // node_0_processing_mem_cmd_width_adapter:out_channel -> node_0_processing_mem_burst_adapter:sink0_channel
	...
	wire  [120:0] cmd_mux_001_src_data;                                      // cmd_mux_001:src_data -> node_1_processing_mem_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                     // node_1_processing_mem_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                   // cmd_mux_001:src_channel -> node_1_processing_mem_cmd_width_adapter:in_channel
	...
	wire  [102:0] node_1_processing_mem_cmd_width_adapter_src_data;          // node_1_processing_mem_cmd_width_adapter:out_data -> node_1_processing_mem_burst_adapter:sink0_data
	...
	wire    [1:0] node_1_processing_mem_cmd_width_adapter_src_channel;       // node_1_processing_mem_cmd_width_adapter:out_channel -> node_1_processing_mem_burst_adapter:sink0_channel
	...
	wire  [120:0] cmd_demux_001_src0_data;                                   // cmd_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [120:0] crosser_002_out_data;                                      // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [120:0] crosser_003_out_data;                                      // crosser_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [120:0] rsp_demux_src0_data;                                       // rsp_demux:src0_data -> crosser_004:in_data
	...
	wire  [120:0] crosser_004_out_data;                                      // crosser_004:out_data -> rsp_mux:sink0_data
	...
	wire  [120:0] rsp_demux_src1_data;                                       // rsp_demux:src1_data -> crosser_005:in_data
	...
	wire  [120:0] crosser_005_out_data;                                      // crosser_005:out_data -> rsp_mux_001:sink0_data
	...
	wire  [120:0] rsp_demux_001_src0_data;                                   // rsp_demux_001:src0_data -> crosser_006:in_data
	...
	wire  [120:0] crosser_006_out_data;                                      // crosser_006:out_data -> rsp_mux:sink1_data
	...
	wire  [120:0] rsp_demux_001_src1_data;                                   // rsp_demux_001:src1_data -> crosser_007:in_data
	...
	wire  [120:0] crosser_007_out_data;                                      // crosser_007:out_data -> rsp_mux_001:sink1_data
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (node_0_reset_processing_reset_bridge_in_reset_reset), //                    reset.reset
		...
		.av_byteenable          (node_0_processing_mem_byteenable),                    //                         .byteenable
		.av_chipselect          (node_0_processing_mem_chipselect),                    //                         .chipselect
		.av_clken               (node_0_processing_mem_clken),                         //                         .clken
		.av_read                (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.av_byteenable          (node_1_processing_mem_byteenable),                    //                         .byteenable
		.av_chipselect          (node_1_processing_mem_chipselect),                    //                         .chipselect
		.av_clken               (node_1_processing_mem_clken),                         //                         .clken
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_outclk1_clk),                                           //             clk.clk
		.reset                   (node_0_reset_processing_reset_bridge_in_reset_reset),       //       clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_router router (
	...
	dircc_system_node_dual_hps_mm_interconnect_0_router router_001 (
	...
	dircc_system_node_dual_hps_mm_interconnect_0_router_002 router_002 (
	...
	dircc_system_node_dual_hps_mm_interconnect_0_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (node_0_reset_processing_reset_bridge_in_reset_reset),       // cr0_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_outclk0_clk),                                                //        clk.clk
		.reset              (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (pll_outclk0_clk),                                                //        clk.clk
		.reset              (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_outclk1_clk),                                     //       clk.clk
		.reset               (node_0_reset_processing_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_outclk1_clk),                                     //       clk.clk
		.reset               (node_0_reset_processing_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_outclk1_clk),                                           //       clk.clk
		.reset              (node_0_reset_processing_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_outclk1_clk),                                           //       clk.clk
		.reset              (node_0_reset_processing_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_outclk0_clk),                                                //       clk.clk
		.reset               (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (pll_outclk0_clk),                                                //       clk.clk
		.reset               (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
		.out_clk           (pll_outclk1_clk),                                                //       out_clk.clk
		.out_reset         (node_0_reset_processing_reset_bridge_in_reset_reset),            // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (node_0_reset_processing_reset_bridge_in_reset_reset),            //  in_clk_reset.reset
		.out_clk           (pll_outclk0_clk),                                                //       out_clk.clk
		.out_reset         (HPS_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	dircc_system_node_dual_hps_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (node_0_reset_processing_reset_bridge_in_reset_reset), // in_rst_0.reset
