// poets_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module poets_system_mm_interconnect_0 (
	...
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> mem_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> mem_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // mem_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> mem_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> mem_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> mem_s1_agent:cp_endofpacket
	...
	wire         mem_s1_agent_rp_valid;                                                     // mem_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] mem_s1_agent_rp_data;                                                      // mem_s1_agent:rp_data -> router_005:sink_data
	wire         mem_s1_agent_rp_ready;                                                     // router_005:sink_ready -> mem_s1_agent:rp_ready
	wire         mem_s1_agent_rp_startofpacket;                                             // mem_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         mem_s1_agent_rp_endofpacket;                                               // mem_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         mem_s1_agent_rdata_fifo_src_valid;                                         // mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] mem_s1_agent_rdata_fifo_src_data;                                          // mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         mem_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_003:in_0_ready -> mem_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> mem_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> mem_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> mem_s1_agent:rdata_fifo_sink_error
	...
	poets_system_mm_interconnect_0_router router (
	...
	poets_system_mm_interconnect_0_router_001 router_001 (
	...
	poets_system_mm_interconnect_0_router_002 router_002 (
	...
	poets_system_mm_interconnect_0_router_002 router_003 (
	...
	poets_system_mm_interconnect_0_router_004 router_004 (
	...
	poets_system_mm_interconnect_0_router_004 router_005 (
	...
	poets_system_mm_interconnect_0_router_002 router_006 (
	...
	poets_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	poets_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
