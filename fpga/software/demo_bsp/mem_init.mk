...
# Memory: streaming_0_mem
MEM_0 := demo_streaming_0_mem
$(MEM_0)_NAME := streaming_0_mem
...
$(MEM_0)_HIERARCHICAL_PATH := streaming_0.mem
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: streaming_0_mem
streaming_0_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
