...
# CPU Name 
# setting CPU_NAME is streaming_0_cpu
CPU_NAME = streaming_0_cpu
...
# setting hal.log_port is streaming_0_jtag_uart
...
# setting hal.stderr is streaming_0_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev streaming_0_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is streaming_0_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev streaming_0_jtag_uart
...
# setting hal.stdout is streaming_0_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev streaming_0_jtag_uart
