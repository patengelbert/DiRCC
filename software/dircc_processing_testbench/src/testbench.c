...
uint32_t dircc_fifo_in_csr_address = FIFO_IN_IN_CSR_BASE;
uint32_t dircc_fifo_in_data_address = FIFO_IN_OUT_BASE;
uint32_t dircc_fifo_in_depth = FIFO_IN_IN_CSR_FIFO_DEPTH;
