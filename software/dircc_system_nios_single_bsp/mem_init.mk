...
# Memory: processing_mem
MEM_0 := dircc_system_nios_single_processing_mem
$(MEM_0)_NAME := processing_mem
...
$(MEM_0)_HIERARCHICAL_PATH := processing.mem
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: processing_mem
processing_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
