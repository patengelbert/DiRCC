...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../fpga/dircc_system_node_single.sopcinfo
...
# CPU Name 
# setting CPU_NAME is node_0_processing_cpu
CPU_NAME = node_0_processing_cpu
...
# Design Name 
# setting SOPC_NAME is dircc_system_node_single
SOPC_NAME := dircc_system_node_single
...
# setting hal.log_port is node_0_processing_jtag_uart
...
# setting hal.stderr is node_0_processing_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev node_0_processing_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is node_0_processing_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev node_0_processing_jtag_uart
...
# setting hal.stdout is node_0_processing_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev node_0_processing_jtag_uart
