...
# Memory: node_0_processing_mem
MEM_0 := dircc_system_node_dual_node_0_processing_mem
$(MEM_0)_NAME := node_0_processing_mem
...
$(MEM_0)_END := 0x0001752f
$(MEM_0)_SPAN := 0x00007530
$(MEM_0)_HIERARCHICAL_PATH := node_0.processing.mem
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: node_0_processing_mem
node_0_processing_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
